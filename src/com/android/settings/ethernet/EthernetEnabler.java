...
public class EthernetEnabler implements CompoundButton.OnCheckedChangeListener  {
    ...
    public EthernetEnabler(Context context, Switch _switch) {
    ...
    public void resume() {
        ...
        setSwitchChecked(mEthManager.getEthState() == ETH_STATE_ENABLED);
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        // TODO: Show toast message if no Ethernet interfaces
        if (isChecked && false) {
            //Toast.makeText(mContext, R.string.eth_no_device, Toast.LENGTH_SHORT).show();
            // Reset switch to off
    ...
    private void setEthEnabled(final boolean enable) {
        ...
        if (LOCAL_LOGD) Slog.d(TAG, "setEthEnabled " + state + " --> " + enable);
